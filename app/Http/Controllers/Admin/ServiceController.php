...
class ServiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $service->custom_fields = json_encode($request->custom_fields);
        $service->slug = $slug;
        ...
        for ($i = 1; $i <= 6; $i++) {
            ...
            $service_translation->{"feature_image_{$i}"} = $request->input("icon{$i}");
        }
        ...
        $service_translation->description_1 = $request->description_1;
        $service_translation->features = $request->features;
        $service_translation->custom_fields = $request->custom_fields;
