        ...
        <div class="col-lg-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{ 'Tutorial ' . trans('messages.information') }}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('tutorial.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label">Tutorial Date</label>
                            <div class="col-md-10">
                                <input type="text" placeholder="YYYY-MM-DD" id="tutorial_date" name="tutorial_date" class="form-control " value="{{ old('tutorial_date') }}" autocomplete="off">
                                @error('tutorial_date')
                                    <div class="alert alert-danger mt-1">{{ $message }}</div>
                                @enderror
                            </div>
