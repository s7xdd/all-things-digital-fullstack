            ...
            <div class="card-body px-0">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <span style="font-size:12px;color: #00b3ff !important;">To highlight specific words, enclose them in
                            square brackets [ ]</span>
                    </div>
                </div>

                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Subtitle<span class="text-danger">*</span>
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-from-label" for="name">Heading 2
                    </label>
                    <div class="col-sm-10">
