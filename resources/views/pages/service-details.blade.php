...
@props([
    'title' => '',
    'subtitle' => null,
    'background' => 'linear-gradient(to bottom, #13166c, #101c5c, #01132f)',
    'topShape' => null,
    'glowImage' => null,
])
...
<x-hero 
    ...
    background="linear-gradient(to bottom, #13166c, #101c5c, #01163a)"
    :topShape="asset('images/shape-top.svg')"
    :glowImage="asset('images/bg-about.svg')"
    class="relative -mt-[100px]"
/>
